...
impl TaskGraphStore {
    ...
    pub fn sessions_for_task(&self, task_id: &str) -> Vec<&SessionHandle> {
        self.sessions
            .values()
    ...
    pub fn children_of_session(&self, parent_session_id: &str) -> Vec<&SessionHandle> {
        self.sessions
            .values()
    ...
    pub fn lead_session_for_task(&self, task_id: &str) -> Option<&SessionHandle> {
