...
| Task 3 | not started | Upgrade Codex parsing/building to the new target model, but defer true agent-targeted routing activation until the routing-kernel task. | Not run yet. | planned |
