...
| Task 6 | `c63f74e2` | Final doc close-out: updated the replacement spec to explicitly mark the SQLite/root-split design as accepted and completed the CM record with accepted outcomes for all tasks. | `git diff --check` ✅ | accepted |
