...
| Task 3 | `_this_` | Closed spec to Accepted; added style-and-dropdowns regression test proving card pills render in persisted order after branded rows and dropdown restyle. | `bun test src/components/TaskPanel/TaskHeader.test.tsx` ✅ 18 passed; `git diff --check` ✅ | accepted |
