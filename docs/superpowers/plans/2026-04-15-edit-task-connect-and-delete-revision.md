...
| Task 3 | pending close-out | Spec marked Accepted and revision CM finalized after Task 1 + Task 2 passed. | `git diff --check -- docs/superpowers/specs/2026-04-15-edit-task-connect-and-delete-revision-design.md docs/superpowers/plans/2026-04-15-edit-task-connect-and-delete-revision.md` pending | pending |
